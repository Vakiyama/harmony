 ...
 */
export declare function makeMightFail<T extends (...args: any[]) => Promise<any>>(func: T): (...funcArgs: Parameters<T>) => Promise<Either<UnwrapPromise<ReturnType<T>>>>;
/**
 ...
 */
export declare function makeMightFailSync<T extends (...args: any[]) => any>(func: T): (...funcArgs: Parameters<T>) => Either<ReturnType<T>>;
export {};
//# sourceMappingURL=makeMightFail.d.ts.map