 ...
 */
export const mightFailSync = function mightFailSync(func) {
    try {
        const result = func();
        return createEither({ error: undefined, result });
    }
    catch (err) {
 ...
 * @param result
 */
export const Might = function Might(result) {
 ...
 * @param error
 */
export const Fail = function Fail(error) {
    return createEither({ result: undefined, error: handleError(error) });
};
