...
export const Menubar = <T extends ValidComponent = "div">(
  ...
  return (
    <MenubarPrimitive
      class={cn(
        "w-[400px] justify-between flex h-9 items-center space-x-1 rounded-md border bg-background p-1 shadow-sm",
        local.class
      )}
      {...rest}
    />
...
export const MenubarTrigger = <T extends ValidComponent = "button">(
  ...
  return (
    <MenubarPrimitive.Trigger
      class={cn(
        "flex cursor-default select-none items-center rounded-sm px-3 py-1 text-xs font-semi outline-none focus:bg-accent focus:text-accent-foreground data-[expanded]:bg-accent data-[expanded]:text-accent-foreground",
        local.class
      )}
      {...rest}
    />
