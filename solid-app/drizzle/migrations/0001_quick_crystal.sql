...
ALTER TABLE `users` ADD `created_at` text DEFAULT '2024-10-15T05:03:36.928Z';--> statement-breakpoint
ALTER TABLE `users` ADD `updated_at` text DEFAULT '2024-10-15T05:03:36.929Z';--> statement-breakpoint
