...
module.exports = {
  safelist: [
    ...
    "bg-sleepBackground",
    "bg-medicationTakenBackground",
    "bg-medicationTakenIconBackground",
    "bg-moodBackground",
  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        sleepBackground: "#D1D8E8",
        medicationTakenBackground: "#FFD5CD",
        medicationTakenIconBackground: "#5B0E00",
